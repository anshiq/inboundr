...
const launcherTiles: LauncherTile[] = [
  ...
  { title: "CRM", description: "Track leads and deals", url: "/crm", icon: HandshakeIcon, feature: "crm", module: "crm" },
  { title: "Employees", description: "Manage your team", url: "/employees", icon: IdCardIcon, feature: "employees", module: "employees" },
  { title: "Recruitment", description: "Run your hiring pipeline", url: "/recruitment", icon: BriefcaseBusinessIcon, feature: "recruitment", module: "recruitment" },
