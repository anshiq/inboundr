    ...
    <Tailwind config={barebonesBoxedTailwindConfig}>
      <Html lang="en">
        ...
        <Body className="bg-bg-2 m-0 text-center font-sans">
          <Preview>You&apos;re on the Inboundr waitlist</Preview>
              ...
              <Section className="bg-bg mobile:px-2 px-6 py-4">
                ...
                <Section className="bg-bg-2 mobile:px-6 mobile:py-12 rounded-[8px] px-[40px] py-[64px] text-center">
                  ...
                  <Text className="font-16 text-fg-2 mx-auto mt-6 mb-0 max-w-[420px] text-center font-sans">
                    Hi {greetingName}, thanks for your interest in Inboundr.
                    We&apos;ve captured your details and our team will contact
                    you soon to get you set up.
                  </Text>
                </Section>
